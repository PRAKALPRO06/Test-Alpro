...
func main() {
	...
	// Tampilkan hasil
	for i := 0; i < n; i++ {
		fmt.Printf("%d(%d) ", t[i].nama_2311102018, t[i].suara)
	}
	fmt.Println()
}

// Fungsi untuk mencari indeks partai berdasarkan nama
func posisi(t TabPartai, n int, nama_2311102018 int) int {
	for i := 0; i < n; i++ {
		if t[i].nama_2311102018 == nama_2311102018 {
			return i
		}
	}
	return -1
